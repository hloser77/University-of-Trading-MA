...
const testimonials = [
  ...
  {
    title: "Meryem el baraka",
    content: "القيمة لي كيعطي هاد السيرفيس صراحة بزاف على الثمن لي كيتخلص.",
    rating: 5,
    image: "",
  },
  {
    title: "Ibrahim Tazi",
    content: "المعلومات معمقة ولكن الشرح مبسّط. هادشي لي محتاج أي مبتدئ.",
    rating: 5,
    image: "",
  },
  {
    title: "Hiba el Mansouri ",
    content: "المحتوى كيزيد كيتطور، وكل نهار كتلقاه أحسن من البارح.",
    rating: 5,
    image: "",
  },
  {
    title: "Khalid Kasmi",
    content: "كتحس بالاحترافية من أول نهار. كل حاجة فبلاصتها.",
    rating: 5,
    image: "",
  },
  {
    title: "Wiam El Houari",
    content: "هاد السيرفيس رجعني من تريدر تائها لتريدر منظم وعارف شنو يدير.",
    rating: 5,
    image: "",
  },
  {
